...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #   keys = [f'W{l+1}', f'b{l+1}']   # list of params
        #   w, b = (self.params.get(k, None) for k in keys) # get param vals

        #   X,cache[l] = affine_forward(X, w, b)
        
        #-----------------------------TO run with Batchnormalization-----------------------------------
        for l in range(self.num_layers):
        ...
        for l in reversed(range(self.num_layers)):
            # dout, dW, db = affine_backward(dout, cache[l])
